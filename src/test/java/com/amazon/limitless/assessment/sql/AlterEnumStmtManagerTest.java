...
public class AlterEnumStmtManagerTest {
    ...
    @Test
    public void test_alterEnumType()
    {
        AlterEnumStmtManager manager = new AlterEnumStmtManager(configLoader);
        PostgreSQLParser.AlterenumstmtContext ctx = mock(
            PostgreSQLParser.AlterenumstmtContext.class
        );

...
public class AlterCompositeTypeStmtManagerTest {
    ...
    @Test
    public void test_alterCompositeType()
    {
        AlterCompositeTypeStmtManager manager = new AlterCompositeTypeStmtManager(configLoader);
        PostgreSQLParser.AltercompositetypestmtContext ctx = mock(
            PostgreSQLParser.AltercompositetypestmtContext.class
        );
